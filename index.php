...
<body class="hold-transition login-page" style="background:white">
  <div class="login-box">
    <div class="login-logo">
      <img src="img/logocompleto.png" alt="" style="width:90%">

    </div>
    <!-- /.login-logo -->
    <div class="card "  >
      <div class="card-header mb-0 pb-0" style="background-color:#92bcdf">
      <p class="login-box-msg text-bold text-white">INICIO DE SESIÓN</p>
      </div>
      <div class="card-body login-card-body" style="border-color:#92bcdf">
        ...
        <form id="formlogin" name="formlogin" action="" method="post">
          <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              <div class="input-group-text" style="color:#92bcdf">
          ...
          <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"  style="color:#92bcdf"></span>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <button type="submit" class="btn text-white btn-block" style="background-color:#92bcdf">Entrar</button>
            </div>
            <!-- /.col -->
          </div>
