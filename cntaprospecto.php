...
$consulta = "SELECT * FROM prospecto WHERE estado_pros=1 and id_clie =0 ORDER BY id_pros";
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $dat['nom_pros'] ?></td>
                        <td><?php echo $dat['tel_pros'] ?></td>
                        <td><?php echo $dat['cel_pros'] ?></td>
                        <td><?php echo $dat['correo_pros'] ?></td>
                        <td></td>
                      </tr>
                    <?php
                    }
